...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-10 flex  max-w-max flex-1 items-center justify-center  w-200 ",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "flex flex-1 list-none items-center justify-end  gap-3 align-right space-x-1", //add group it got removed from original
      className
    )}
    {...props}
  />
